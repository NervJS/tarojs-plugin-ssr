 ...
 * 停止监听设备方向的变化。
 */
export const stopDeviceMotionListening = ({ success, fail, complete } = {} as any) => {
 ...
 * 开始监听设备方向的变化。
 */
export const startDeviceMotionListening = ({ interval = 'normal', success, fail, complete } = {} as any) => {
